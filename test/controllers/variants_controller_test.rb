...
class VariantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post variants_url, params: { variant: { categories_id: @variant.categories_id, variant_type: @variant.variant_type } }
    end
  ...
  test "should update variant" do
    patch variant_url(@variant), params: { variant: { categories_id: @variant.categories_id, variant_type: @variant.variant_type } }
